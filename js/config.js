...
const COUNTRY_TO_LANG = { en: 'en', cn: 'cn', kr: 'ko' };
...
const UI_TEXT = {
    en: {
        ...
        CUT_WEIGHT_HINT: 'Based on Max thickness',
    ...
    cn: {
        ...
        RUBBER: '胶皮',
        SPEED: '速度',
        SPEED_HINT: '速度排名 # = 30% 回合速度 + 30% 弹性 + 40% 最大速度',
        SPIN: '旋转',
        SPIN_HINT: '旋转排名 # = 40% 发球摩擦 + 40% 起板旋转 + 20% 短球旋转',
        USER_GUIDE: '使用指南',
        CUT_WEIGHT: '裁切重量',
        CUT_WEIGHT_HINT: '基于最大厚度',
        CONTROL_HINT: '5 = 更易控制，1 = 较难控制',
        RELEASE: '发售',
        THICKNESS: '厚度',
        PLAYERS: '选手',
        FEEDBACK_BUTTON: '反馈',
        ...
        CONTENT_FEEDBACK_REASON_PLACEHOLDER: '有什么不好或可以改进的地方？',
